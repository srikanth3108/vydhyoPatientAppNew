...
type RentalPaymentGatewayRouteProp = RouteProp<RootStackParamList, 'RentalPaymentGateway'>;

interface RentalPaymentGatewayProps {
  route: RentalPaymentGatewayRouteProp;
}

type Nav = StackNavigationProp<RootStackParamList>;

const RentalPaymentGateway: React.FC<RentalPaymentGatewayProps> = ({ route }) => {
  ...
  const handlePaymentVerification = async (verifiedOrderId: string) => {
    ...
    try {
      ...
      const verifyResult = await verifyRentalOrderPayment(verifiedOrderId);
...
export default RentalPaymentGateway;
